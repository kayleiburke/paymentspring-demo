  ...
  >
    ...
    <v-card>
      <v-container grid-list-xl>
        <v-layout wrap>
          <v-flex xs12>
            <div class="text-xs-center body-2 text-uppercase sidebar-filter">Sidebar Color</div>
          ...
          <v-flex
            xs12
          >
            <div class="text-xs-center body-2 text-uppercase sidebar-filter">Sidebar Background Image</div>
          </v-flex>
          <v-flex
            v-for="img in images"
            :key="img"
